...
function DayDialog({
  ...
  const addActivity = async (type) => {
    ...
    setActivities([
      { ...addedActivity.data(), id: addedActivity.id },
      ...activities,
    ]);
  };
  ...
  return (
    <Dialog open={!!selectedDate} onClose={handleModalClose}>
      <DialogTitle style={{ padding: '16px' }}>
        <TitleContent>
          ...
          <DateTitle>
            {monthFromDate(selectedDate)} {dayOrderFromDate(selectedDate)},{' '}
      ...
      <DialogContent>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <ListItemText
                      primary={getPrimaryText(activity)}
                      secondary={getSecondaryText(activity)}
                    ></ListItemText>
                  </ListItemButton>
                </ListItem>
              );
            ...
            {activitiesForDay.length === 0 && (
              <ListItem>
                ...
                <ListItemText
                  ...
                  secondary="You can add them from below"
                ></ListItemText>
              </ListItem>
            )}
          </List>
        ...
        <BGWrapper>
          ...
          <ButtonGroup size="large">
            <Button title="Walk" onClick={() => addActivity('Walk')}>
              <TypeIcon type="Walk" />
            </Button>
            <Button title="Run" onClick={() => addActivity('Run')}>
              <TypeIcon type="Run" />
            </Button>
            <Button title="Gym" onClick={() => addActivity('Gym')}>
              <TypeIcon type="Gym" />
            </Button>
            <Button title="Cycle" onClick={() => addActivity('Cycle')}>
              <TypeIcon type="Cycle" />
            </Button>
          </ButtonGroup>
        </BGWrapper>
